...
module.exports = {
    ...
    replaceUncommentedLine: function(text, prefix) {
        return this.getCommentPrefix(prefix) + text + this.DEFAULT_SUFFIX;
    },

    replaceCommentedLine: function(text, prefix) {
        return text.replace(this.getCommentPrefix(prefix), '') + this.DEFAULT_SUFFIX;
    },
    ...
    addComment: function(text, ext, type) {
        ...
        return (
            this.getCommentPrefix(phonemes.prefix, type) + text +
    ...
    removeComment: function(text, ext, type) {
        ...
        strippedText = strippedText.substr(
            phonemes.prefix.length, strippedText.length);
        strippedText = strippedText.substr(
            0,
